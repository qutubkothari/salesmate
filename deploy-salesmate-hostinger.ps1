...
$migrations = @("001_multi_user_support.sql", "002_missing_tables.sql", "003_fix_schema_issues.sql", "004_additional_columns.sql", "005_fix_interactive_schema.sql", "006_conversation_learning.sql")
