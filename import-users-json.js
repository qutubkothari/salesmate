/**
 * Import Users from Supabase JSON Export
 * Usage: node import-users-json.js
 */
...
try {
  ...
  const insertStmt = db.prepare(`
    INSERT OR REPLACE INTO users (
      id, tenant_id, phone, name, password, role,
  ...
  const imported = transaction(usersData);

  console.log(`✅ Imported ${imported} users successfully!\n`);
